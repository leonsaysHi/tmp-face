...
class AttachSAPControllerTest extends TestCase
{
    /**
     * @covers App\Http\Controllers\AttachSAPController::__invoke
     * @covers App\SAPRepository::attach
     */
    public function testAttachSap()
    {
        ...
        $payload = ['projectSfdcId' => 'foo','sapSfdcIds' => ['bar']];

        $this->post('/api/attach-sap', $payload)
            ->assertStatus(200)
            ->assertJsonFragment([
                'saps' => [[
                    'sfdcId' => 'foo',
