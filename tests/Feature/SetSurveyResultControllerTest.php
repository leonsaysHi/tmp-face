...
class SetSurveyResultControllerTest extends TestCase
{
    /**
     * @covers \App\Http\Controllers\SetSurveyResultController::__invoke
     * @covers \App\SurveyRepository::setResults
     */
    public function testSetSurveyResult()
    {
        ...
        $mock = new MockHandler([
            ...
            new Response(200, [], "{\"message\":\"foo\",\"surveySfdcId\":\"bar\",\"errorCode\":\"200\"}"),
        ]);
        $handler = HandlerStack::create($mock);
        $mock = new Client(['handler' => $handler]);
        $this->app->instance(Client::class, $mock);

        $this->post('/api/survey/set-result')
            ->assertStatus(200)
            ->assertJsonFragment([
                'message' => 'foo',
                'surveySfdcId' => 'bar',
