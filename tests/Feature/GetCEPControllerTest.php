...
class GetCEPControllerTest extends TestCase
{
    /**
     * @covers App\Http\Controllers\GetCEPController::__invoke
     * @covers App\CEPRepository::get
     */
    public function testGetCEP()
    {
        ...
        $payload = ['projectSfdcId' => 'foo'];

        $this->post('/api/get-cep', $payload)
            ->assertStatus(200)
            ->assertJsonFragment([
                'cep' => [[
                    'sfdcId' => 'foo',
