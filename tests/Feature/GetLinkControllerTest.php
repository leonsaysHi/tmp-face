...
class GetLinkControllerTest extends TestCase
{
    /**
     * @covers App\Http\Controllers\GetLinkController::__invoke
     * @covers App\GetLinkRepository::getLink
     */
    public function testGetLink()
    {
        ...
        $mock = new MockHandler([
            ...
            new Response(200, [], "{\"links\":[{\"name\":\"foo\", \"url\":\"bar\"}],\"errorCode\":\"200\"}"),
        ]);
