...
class GetQuestionControllerTest extends TestCase
{
    /**
     * @covers \App\Http\Controllers\GetQuestionController::__invoke
     * @covers \App\SurveyRepository::getQuestion
     */
    public function testExample()
    {
        ...
        $mock = new MockHandler([
            ...
            new Response(200, [], "{\"message\":\"foo\",\"questions\":[],\"errorCode\":\"200\"}"),
        ]);
        $handler = HandlerStack::create($mock);
        $mock = new Client(['handler' => $handler]);
        $this->app->instance(Client::class, $mock);

        $this->get('/api/survey/get-question')
            ->assertStatus(200)
            ->assertJsonFragment([
                'message' => 'foo',
                'questions' => [],
