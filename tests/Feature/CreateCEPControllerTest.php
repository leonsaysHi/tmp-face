...
class CreateCEPControllerTest extends TestCase
{
    /**
     * @covers App\Http\Controllers\CreateCEPController::__invoke
     * @covers App\CEPRepository::createManual
     */
    public function testCreate()
    {
        ...
        $mock = new MockHandler([
            ...
            new Response(200, [], "{\"cepSfdcId\":\"foo\",\"errorCode\":\"200\"}"),
        ]);
        ...
        $payload = ['projectSfdcId' => 'bar','CEPId' => 'bar','CEPFolderId' => 'bar','CEPStatus' => 'bar'];

        $this->post('/api/create-cep', $payload)
            ->assertStatus(200)
            ->assertJsonFragment([
                'cepSfdcId' => 'foo'
            ]);
